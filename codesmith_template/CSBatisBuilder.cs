...
namespace CSBatisBuilder
{
    ...
    public class DaoIntfOption : ClassOption
    {
        ...
        private const String m_DefaultNameFmt = "I{0}DataService";
    ...
    public class DaoImplOption : ClassOption
    {
        ...
        private const String m_DefaultNameFmt = "{0}DataService";
    ...
    public class DaoMethodSetOption
    {
        ...
        private DaoMethodOption m_FindOption = new DaoMethodOption("{0}Get");//Find
        ...
        #region GetListOption

        private DaoMethodOption m_GetListOption = new DaoMethodOption("{0}GetList");

        [Description("Gets or sets the options for GetList method.")]
        public DaoMethodOption GetListOption
        {
            get { return m_GetListOption; }
            set { m_GetListOption = value; }
        }
        ...
        private DaoMethodOption m_GetAllOption = new DaoMethodOption("{0}GetAll");

        [Description("Gets or sets the options for GetAll method.")]
        public DaoMethodOption GetAllOption
        {
            get { return m_GetAllOption; }
            set { m_GetAllOption = value; }
        }
    ...
    public class ColumnInfo
    {
        ...
        public ColumnInfo(ColumnSchema column, MemberOption memberOption, IDbVendor dbVendor)
        {
            ...
            //特别注意，此使用改为Column.Name
            m_PropName = Column.Name; //GetPropName(Column, MemberOption);
    ...
    public class TableBuilder : ITableBuilderOption
    {
        ...
        public TableBuilder(TableSchema sourceTable, ITableBuilderOption builderOption)
        {
            ...
            m_QualifiedTableName = TableName; //DbVendor.QuotedStr(SourceTable.Owner) + "." +
        ...
        [Category(Categories.DebugInfo)]
        public string GetListStmtId
        {
            get { return String.Format(DaoMethodSetOption.GetListOption.IdFmt, IdBase); }
        }
        [Category(Categories.DebugInfo)]
        public string GetAllStmtId
        {
            get { return String.Format(DaoMethodSetOption.GetAllOption.IdFmt, IdBase); }
        }
        [Category(Categories.DebugInfo)]
        ...
        {
            String s = tableName;
            s = s.Substring(0, 1).ToUpper() + s.Substring(1) + "Info";
