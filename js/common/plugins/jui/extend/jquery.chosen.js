...
((function() {
    ...
    a.select_to_array = function(b) {
        ...
        d = new a,
        g = b.childNodes;
        for (e = 0, f = g.length; e < f; e++) c = g[e],
        d.add_node(c);
        return d.parsed
    },
    this.SelectParser = a
...
function() {
    ...
    b = function(b) {
        ...
        e.prototype.container_mousedown = function(b) {
            var c;
            if (!this.is_disabled) return c = b != null ? a(b.target).hasClass("search-choice-close") : !1,
        ...
        e.prototype.results_build = function() {
            ...
            a = "",
            f = this.results_data;
            for (c = 0, e = f.length; c < e; c++) b = f[c],
        ...
        e.prototype.search_results_mouseup = function(b) {
            ...
            if (c.length) return this.result_highlight = c,
        ...
        e.prototype.result_select = function(a) {
            ...
            d,
            e;
            if (this.result_highlight) return b = this.result_highlight,
            c = b.attr("id"),
            this.result_clear_highlight(),
        ...
        e.prototype.search_field_scale = function() {
            ...
            if (this.is_multiple) {
                ...
                for (i = 0, j = g.length; i < j; i++) e = g[i],
